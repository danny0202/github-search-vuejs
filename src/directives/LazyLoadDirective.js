...
export default {
  inserted: (el) => {
    ...
    function createObserver() {
      ...
      // Whether you're using the viewport or some other element as the root,
      //    the API works the same way,
      // executing a callback function you provide whenever the visibility
      //    of the target element changes
